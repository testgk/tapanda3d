...
class Detector:
	...
	def getDetection( self, target = None, locatorMode: Locators = None, lastDetection: bool = False ):
		global edge
		...
		self.__rays.append( self.__visualize_ray( start = edge, color = Color.RED if lastDetection else Color.GREEN,
	...
	def __visualize_ray( self, start, end, color = Color.GREEN, thickness = 3.0 ):
